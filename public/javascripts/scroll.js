...
// This is the poll toggle
$(document).ready(function() {
  var poll_boxes = $('#poll_components .poll_component_box');
  var container = $('#poll_components');
  var poll_container = $('#poll_components_wrap').css('overflow', 'hidden');
  
  var pollScrollOptions = {
    target: poll_container,
    items: poll_boxes,
    navigation: '#poll_buttons a',
    duration: 500,
    axis: 'xy',
    easing: 'swing'
  };
  $('#poll').serialScroll(pollScrollOptions);
});
...
jQuery(document).ready(function() {
  ...
  var scrollOptions = {
    ...
    prev: 'img.banner_scroll.l',
    next: 'img.banner_scroll.r',
    axis: 'xy',
    duration: 500,
    easing: 'swing',
    onAfter: trigger
